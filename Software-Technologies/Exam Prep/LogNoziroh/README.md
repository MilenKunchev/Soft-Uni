...
options </b>to <b>view details about them</b> or <b>delete</b> them.<img
width=695 height=225 id="Picture 6" src="readme.md_files/image001.jpg"></p>
...
height=396 id="Picture 7" src="readme.md_files/image002.jpg"></p>

<h3>Details Page</h3>

<h4>Route: <span class=CodeChar><span style='color:windowtext'>“/details/{id}”</span></span></h4>

<p class=MsoNormal align=center style='text-align:center'><img width=545
height=420 id="Picture 9" src="readme.md_files/image003.jpg"></p>

<h3>Delete Page</h3>

<h4>Route: <span class=CodeChar><span style='color:windowtext'>“/delete/{id}”</span></span></h4>

<p class=MsoNormal align=center style='text-align:center'><img width=522
height=395 id="Picture 12" src="readme.md_files/image004.jpg"></p>
...
<p class=MsoNormal>Implement the “<b>LogNoziroh” app</b> using all the above
